...
private:
    ...
    std::string warnning;  // Warning message
    ...
    unsigned int size;  // The maximum number of characters allowed in the text field
    bool hasfocus;  // Whether the text field is currently focused
    bool isWarnning = false;  // Whether there is a warning
